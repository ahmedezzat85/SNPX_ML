...
def snpx_net_create(num_classes, input_data, data_format='NHWC', is_training=True):
    ...
    net.convolution(64, (3,3), is_batch_norm=True, name='conv1_a')
    net.convolution(64, (3,3), is_batch_norm=True, name='conv1_b')
    net.pooling('max', (2,2), name='pool1')
    
    # CONVOLUTION_2 3x3/1,128 
    net.convolution(128, (3,3), is_batch_norm=True, name='conv2_a')
    net.convolution(128, (3,3), is_batch_norm=True, name='conv2_b')
    net.pooling('max', (2,2), name='pool2')

    # CONVOLUTION_3 3x3/1,256
    net.convolution(256, (3,3), is_batch_norm=True, name='conv3_a')
    net.convolution(256, (3,3), is_batch_norm=True, name='conv3_b')
    net.convolution(10, (1,1), is_batch_norm=True, name='conv_4')
