...
def cifar10_resnet_v2_generator(data, is_training, resnet_size, num_classes, data_format='channels_first'):
  ...
  inputs = conv2d_fixed_padding(
      inputs=data, filters=16, kernel_size=3, strides=1,
      data_format=data_format)
  ...
  inputs = batch_norm_relu(inputs, is_training, data_format)
  inputs = tf.layers.average_pooling2d(inputs=inputs, pool_size=1, strides=1, data_format=data_format)
