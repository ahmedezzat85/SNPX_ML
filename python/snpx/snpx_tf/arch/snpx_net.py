...
def model_B(net):
    net.convolution(16, (3,3), stride=(1,1), name='Conv0')
    net.conv_dw(16 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv1')
    net.conv_dw(16 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv2')
    net.conv_dw(32 , (3,3), stride=(2,2), add_batch_norm=True, name='Conv3')
    net.conv_dw(32 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv4')
    net.conv_dw(32 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv5')
    net.conv_dw(32 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv6')
    net.conv_dw(64 , (3,3), stride=(2,2), add_batch_norm=True, name='Conv7')
    net.conv_dw(64 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv8')
    net.conv_dw(64 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv9')
    net.conv_dw(64 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv10')
    net.conv_dw(64 , (3,3), stride=(1,1), add_batch_norm=True, name='Conv11')
    net.pooling('avg', (4,4), name="global_pool")
    return net
